                            ...
                            if(typeof settings.onClick === "function") {
                                if(settings.format) {
                                    if(settings.format === "moment") {
                                        ...
                                        settings.onClick.call(this, timeSelected.format(settings.format,curr_obj));
                                    }
                                } else {
    ...
    var methods = {
        init: function(options){
            ...
            return this.each(function(){
                ...
                settings.onClick = function(date,curr_obj=null){
                    $($input).closest('.has-danger').removeClass('has-danger');  
                    $($input).next().hide();
                ...
                var openPopup = function(){
                    ...
                    $popup.css("left", (x) + "px").css("top", (y + 35) + "px");
